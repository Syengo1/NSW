...
export default function NewDropPage() {
  ...
  const [colorsInput, setColorsInput] = useState('Black, Off-White');
          ...
          <div className="bg-card border border-border p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <div>
                 ...
                 <select name="category" className="w-full bg-secondary border border-border p-4 text-sm text-white uppercase outline-none"><option>Hoodies</option><option>T-Shirts</option><option>Outerwear</option></select>
               </div>
               <div>
                 <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2 block">Gender</label>
                 <select name="gender" className="w-full bg-secondary border border-border p-4 text-sm text-white uppercase outline-none"><option value="unisex">Unisex</option><option value="men">Mens</option></select>
               </div>
               <div className="col-span-2">
